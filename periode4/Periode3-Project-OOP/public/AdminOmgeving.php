                    ...
                    <?php if ($producten -> num_rows > 0){
                        while ($rows = $producten -> fetch_array()){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="AdminOmgeving.php?edit=<?php echo $rows['productID']; ?>" class="edit_btn" >View</a>
                                </td>
                                <td>
                                    <a href="../src/server.php?del=<?php echo $rows['productID']; ?>" class="del_btn">Delete</a>
                                </td>
                            </tr>
                            <?php
                        }
...
<!--                    <input type="text" name="typecomponent" value="--><?php //echo $typeComponent?><!--">-->
                    ...
                    <div class="input-group">
                        <?php if ($update == true){ ?>
                            ...
                            <button class="btn" type="submit" name="cancel" style="background: orangered;" >cancel</button>
                        <?php }else{ ?>
