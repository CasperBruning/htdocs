...
x`
                                    ...
                                    if ($atxCase->num_rows > 0) {
                                        while($row = $atxCase->fetch_array()) {
                                            ?>
                                            <option name="case" value="<?php echo $row['productID'] ?>" class="caseOption atx"><?php echo $row['naam'] . " €" . $row['prijs']?></option>
                                            <?php
                                        }
                                    } else {
                                        echo "0 results";
                                    ...
                                    if ($microatxCase->num_rows > 0) {
                                        while($row = $microatxCase->fetch_array()) {
                                            ?>
                                            <option name="case" value="<?php echo $row['productID'] ?>" class="caseOption microatx"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                            <?php
                                        }
                                    } else {
                                        echo "0 results";
                                    ...
                                    if ($miniitx->num_rows > 0) {
                                        while($row = $miniitx->fetch_array()) {
                                            ?>
                                            <option name="case" value="<?php echo $row['productID'] ?>" class="caseOption miniitx"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                            <?php
                                        }
                                    } else {
                                        echo "0 results";
...
<!--                                    INTEL CPU-->
                                    ...
                                    if ($intelCpu->num_rows > 0) {
                                        while($row = $intelCpu->fetch_array()) {
                                            ?>
                                            <option name="cpu" value="<?php echo $row['productID'] ?>" class="caseOption intel"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                            <?php
                                        }
                                    } else {
                                        echo "0 results";
...
<!--                                    AMD CPU-->
                                    ...
                                    if ($amdCpu->num_rows > 0) {
                                        while($row = $amdCpu->fetch_array()) {
                                            ?>
                                            <option name="cpu" value="<?php echo $row['productID'] ?>" class="caseOption amd"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                            <?php
                                        }
                                    } else {
                                        echo "0 results";
...
<!--                                RAM-->
                                ...
                                if ($ram->num_rows > 0) {
                                    while($row = $ram->fetch_array()) {
                                        ?>
                                        <option name="ram" value="<?php echo $row['productID'] ?>" class="caseOption ram"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                        <?php
                                    }
                                } else {
                                    echo "0 results";
                            ...
                            <select name="cpucooler" class="cpucoolerselect">
                                ...
                                if ($cpuCooler->num_rows > 0) {
                                    while($row = $cpuCooler->fetch_array()) {
                                        ?>
                                        <option name="cpucooler" value="<?php echo $row['productID'] ?>" class="caseOption cpucooler"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                        <?php
                                    }
                                } else {
                                    echo "0 results";
                            ...
                            <select name="mobo" class="moboselect">
                                ...
                                if ($moboAtx->num_rows > 0) {
                                    while($row = $moboAtx->fetch_array()) {
                                        ?>
                                        <option name="mobo" value="<?php echo $row['productID'] ?>" class="caseOption atx"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                        <?php
                                    }
                                } else {
                                    echo "0 results";
...
<!--                                MICRO ATX MOBO-->
                                ...
                                if ($moboMicroAtx->num_rows > 0) {
                                    while($row = $moboMicroAtx->fetch_array()) {
                                        ?>
                                        <option name="mobo" value="<?php echo $row['productID'] ?>" class="caseOption microatx"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                        <?php
                                    }
                                } else {
                                    echo "0 results";
...
<!--                                MINI ITX MOBO-->
                                ...
                                if ($moboMiniItx->num_rows > 0) {
                                    while($row = $moboMiniItx->fetch_array()) {
                                        ?>
                                        <option name="mobo" value="<?php echo $row['productID'] ?>" class="caseOption miniitx"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                        <?php
                                    }
                                } else {
                                    echo "0 results";
...
<!--                                    NVIDIA GPU-->
                                    ...
                                    if ($nvidiaGPU->num_rows > 0) {
                                        while($row = $nvidiaGPU->fetch_array()) {
                                            ?>
                                            <option name="gpu" value="<?php echo $row['productID'] ?>" class="caseOption nvidia"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                            <?php
                                        }
                                    } else {
                                        echo "0 results";
...
<!--                                    RADEON GPU-->
                                    ...
                                    if ($radeonGPU->num_rows > 0) {
                                        while($row = $radeonGPU->fetch_array()) {
                                            ?>
                                            <option name="gpu" value="<?php echo $row['productID'] ?>" class="caseOption radeon"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                            <?php
                                        }
                                    } else {
                                        echo "0 results";
                                ...
                                <select name="fan" class="fanselect">
                                    ...
                                    if ($fan->num_rows > 0) {
                                        while($row = $fan->fetch_array()) {
                                            ?>
                                            <option name="fan" value="<?php echo $row['productID'] ?>" class="caseOption"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                            <?php
                                        }
                                    } else {
                                        echo "0 results";
                            ...
                            <select id="opslag" name="opslag" class="opslagselect">
                                ...
                                if ($opslag->num_rows > 0) {
                                    while($row = $opslag->fetch_array()) {
                                        ?>
                                        <option name="opslag" value="<?php echo $row['productID'] ?>" class="caseOption"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                        <?php
                                    }
                                } else {
                                    echo "0 results";
                            ...
                            <select name="psu" class="kabelSelect">
                                ...
                                if ($psu->num_rows > 0) {
                                    while($row = $psu->fetch_array()) {
                                        ?>
                                        <option name="psu" value="<?php echo $row['productID'] ?>" class="caseOption"><?php echo $row['naam'] . " €" . $row['prijs'] ?></option>
                                        <?php
                                    }
                                } else {
                                    echo "0 results";
...
<!--                                Kabel EXTENSIONS-->
                                ...
                                if ($kabels->num_rows > 0) {
                                    while($row = $kabels->fetch_array()) {
                                        print_r($row)
                                        ?>
                                        <option name="kabel" value="<?php echo $row['productID'] ?>" class="caseOption"><?php echo $row['naam'] . " €" .  $row['prijs']; ?></option>
                                        <?php
                                    }
                                } else {
                                    echo "0 results";
                            ...
                            <select name="prebuild" class="kabelSelect">
                                <option value="Ja" class="caseOption">Zet hem maar in elkaar voor mij!</option>
                                <option value="Nee" class="caseOption">Dat doe ik zelf wel</option>
